...
const createQaMarkdown = (item: BlueprintInventoryItem) => {
  ...
  const preliminary =
    typeof metadata.preliminary === "string"
      ? metadata.preliminary
      : "Análisis preliminar disponible. Requiere completar el Blueprint final.";

  return `# Blueprint Estratégico — ${item.business_name || "Proyecto sin nombre"}
...
- Clarificar cliente ideal.
- Definir propuesta de valor principal.
- Mapear el flujo actual desde contacto hasta entrega.
- Identificar tareas manuales repetitivas.

### Días 31-60: Sistema Operativo
- Diseñar proceso mínimo de seguimiento comercial.
- Automatizar recordatorios y clasificación de prospectos.
- Crear una base central de oportunidades.
- Medir conversión por etapa.

### Días 61-90: Escalamiento
- Optimizar canales de adquisición.
- Documentar operaciones críticas.
- Preparar automatizaciones de ventas y entrega.
- Definir el siguiente bloque de implementación.

## Recomendación

El siguiente paso recomendado es convertir esta idea en un sistema mínimo operable antes de invertir en adquisición agresiva.`;
};
