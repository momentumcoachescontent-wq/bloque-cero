import { Target, Users, Zap, Activity, CheckCircle } from "lucide-react";
...
export const AdminRadarExpanded = ({ lead, downloadJson, handleDelete, toggleFlag }: RadarExpandedProps) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-card p-6 rounded-2xl border border-border/80 shadow-sm relative overflow-hidden group hover:border-primary/30 transition-colors">
            ...
            <h4 className="text-sm font-bold uppercase tracking-wide text-primary border-b border-border/50 pb-3 mb-4 flex items-center gap-2 relative z-10">
              <Users className="w-4 h-4" /> 1. Input del Emprendedor
            </h4>
            <div className="space-y-4 text-sm relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2 border-t border-border/30">
                ...
                <div>
                  <span className="text-muted-foreground block mb-1 text-xs uppercase tracking-wider">Desarrollo:</span>
